...
class HelloApp(WinForms.Form):
    ...
    def __init__(self):
        ...
        self.MinimumSize = Size(400, (160 + h))

        # Create the button
        self.button = WinForms.Button()
        self.button.Location = Point(20, 64)
        self.button.Size = Size(120, 32)
        ...
        self.textbox.Size = Size(120, 40)
        self.textbox.Location = Point(20, 24)
